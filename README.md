...
# The Process:
I realized after understanding the basics of how this game worked on the inside that I could build it the parts lying in my box of things. Firstly, I grabbed a breadboard because I did not feel like soldering at all and my soldering skills kinda sucks. I grabbed all the nesacrry components which are listed in tools used. I then looked for a schematic of the display and sensor I was using. 
...
insert image of it 
So in the end that didn't work, BUT I did not let that stop me. I found these mini breadboards I had bought from a future project I'm planning and put them together so I can now fit the ESP32 and the other components on the board. I also resoldered the pins on the display to be more neater. Overall it led to wiring and the look to be much cleaner and easier to work with

# Coding
After wiring everything, I loaded up Arduino IDE and began to code. I have more experience with MicroPython in Thonny but lately I've been using Arduino to familizar myself with it. 
